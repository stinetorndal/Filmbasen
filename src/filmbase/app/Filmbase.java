...
public class Filmbase {
    //private Map<Genre, Set<Film>> genreFilms = new HashMap<>();
    ...
    //Genre []genres ={Genre.Christmas, Genre.Comedy};


    private void initAndAdd() {
        alleFilm.add(new Film("A new hope", 1977, Genre.Scifi, Genre.Action));
        ...
        alleFilm.add(new Film("Titan A.E", 2000, Genre.Scifi, Genre.Anime));
        alleFilm.add(new Film("Step Brothers", 2008, Genre.Comedy));
        alleFilm.add(new Film("Lord of the Rings", 2001, Genre.Fantasy, Genre.Action));
        alleFilm.add(new Film("Elf", 2003, Genre.Comedy, Genre.Christmas));
        alleFilm.add(new Film("Avatar", 2009, Genre.Scifi, Genre.Fantasy, Genre.Action));
        alleFilm.add(new Film("Independence Day", 1996, Genre.Scifi, Genre.Action));
        ...
        alleFilm.add(new Film("The Greatest night of pop", 2024,Genre.Music, Genre.Documentary));
        alleFilm.add(new Film("Polarekspressen", 2004, Genre.Christmas));
        alleFilm.add(new Film("IT", 2017, Genre.Horror, Genre.Documentary));
